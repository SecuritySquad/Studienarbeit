...
\lstset{
    style=eclipsejava,
    caption={Beispiel eines simplen Java PortScanners},
...
Im Folgenden wird ein beispielhafter Phishingangriff auf PayPal geschildert. PayPal ist\ldots\footcite[Vgl.][]{paypal}

\todo{Samuel: Klassischen Verlauf beschreiben}
