...
Es können beliebig viele Tests im Tester hinzugefügt werden, indem sie in der Konfiguration spezifiziert werden.
Jeder dieser Tests gibt ein eigenes Ergebnis sowie weitere Informationen aus.
Diese Einzeltestergebnisse werden dann miteinander verrechnet und es wird eine Gesamteinschätzung zusammen mit allen relevanten Informationen der einzelnen Tests an die webifier Platform bzw. an webifier Mail weitergeleitet.
Schließlich wird das Ergebnis dem Nutzer über den Browser bzw. über eine Antwortmail präsentiert.
Dabei ist der Weg über die Plaform der Standard Use Case von webifier.
...
Im Mail-Server werden dann bis zu fünf in der Mail enthaltene Links an den Tester weitergeleitet.
