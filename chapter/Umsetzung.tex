...
Die Methode \lstinline[style=eclipse]{/count} liefert einfach nur die aktuelle Gesamtzahl der in webifier Data vorhandenen Testergebnisse. Die Antwort wird in Listing \ref{lst:data-count} dargestellt.

\begin{scriptsize}
\lstset{
    style=eclipsejavascript,
    caption={Inhalt count-Response - webifier Data},
    label={lst:data-count}
}
\begin{lstlisting}
{
    "size" : 172087
